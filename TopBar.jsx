  ...
  return(
    <div style={{padding:"8px 12px",display:"flex",alignItems:"center",gap:8,background:"rgba(5,9,18,.96)",borderBottom:"1px solid rgba(255,255,255,.03)",zIndex:20,flexShrink:0}}>
      ...
      <div style={{display:"flex",gap:4,alignItems:"center"}}>
        {/* Zoom controls */}
        {tanks.length>1&&(<div style={{display:"flex",alignItems:"center",gap:2,background:"rgba(255,255,255,.03)",borderRadius:5,padding:"2px 3px",border:"1px solid rgba(255,255,255,.04)"}}>
        ...
        {actTank&&(actTank.fishes||[]).length>0&&<button onClick={openPurge} style={{...iconBtn,color:"#FF4757",fontSize:showSingle?11:14}}>{"\u2622"}</button>}
      </div>
    </div>);
}
